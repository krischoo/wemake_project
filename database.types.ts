  ...
  public: {
    Tables: {
      ...
      product_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_reviews_product_id_products_product_id_fk"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "product_overview_view"
            referencedColumns: ["product_id"]
          ...
          {
            foreignKeyName: "product_reviews_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
    ...
    Enums: {
      event_type: "product_view" | "product_click" | "profile_view"
      job_type:
        | "full-time"
        | "part-time"
        | "remote"
      ...
      product_stage: "planning" | "development" | "design" | "launch" | "growth"
      role:
        | "독서 리뷰"
        | "창작 글쓰기"
        | "시/에세이"
